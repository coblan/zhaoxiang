...
weixin = {
    '北崧居委': ['任远青', '谭伟明', '江洁', '吴滢', '陶惠芬', '朱惠萍', '查莉蕾', 
                     '李洪喜', '胡卓琳', '邹天宇', '陆伟峰', '史晓燕'],
